...
export interface ApiHeadlinerHeadliner extends Schema.CollectionType {
  collectionName: 'headliners';
  info: {
    singularName: 'headliner';
    pluralName: 'headliners';
